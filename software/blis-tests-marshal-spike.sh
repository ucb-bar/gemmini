...
./marshal -v --no-disk --workdir /scratch/alonamid/chipyard-gemmini-blas/generators/gemmini/software/ build blis-tests.json
./marshal -v --no-disk --workdir /scratch/alonamid/chipyard-gemmini-blas/generators/gemmini/software/ launch --spike blis-tests.json
cd $RDIR
