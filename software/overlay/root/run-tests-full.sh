...
echo "=========conv========="
echo "=========conv-linux=========" >> test_output.txt
/root/bareMetalC/conv-linux >> test_output.txt
echo "=========conv_with_pool-linux=========" >> test_output.txt
/root/bareMetalC/conv_with_pool-linux >> test_output.txt

echo "========mobilenet========="
echo "========mobilenet CPU=========" >> test_output.txt
/root/imagenet/mobilenet-linux cpu matmul >> test_output.txt
echo "========mobilenet conv CPU=========" >> test_output.txt
/root/imagenet/mobilenet-linux cpu conv >> test_output.txt
...
/root/imagenet/resnet50-linux cpu matmul >> test_output.txt
echo "========ResNet50 conv CPU=========" >> test_output.txt
/root/imagenet/resnet50-linux cpu conv >> test_output.txt
...
echo "========MLP 1 (32)========="
echo "========MLP 1 (32) OS=========" >> test_output.txt
/root/mlps/mlp1_32-linux os >> test_output.txt
echo "========MLP 1 (32) WS=========" >> test_output.txt
/root/mlps/mlp1_32-linux ws >> test_output.txt
echo "========MLP 2 (32)========="
echo "========MLP 2 (32) OS=========" >> test_output.txt
/root/mlps/mlp2_32-linux os >> test_output.txt
echo "========MLP 2 (32) WS=========" >> test_output.txt
/root/mlps/mlp2_32-linux ws >> test_output.txt
echo "========MLP 3 (32)========="
echo "========MLP 3 (32) OS=========" >> test_output.txt
/root/mlps/mlp3_32-linux os >> test_output.txt
echo "========MLP 3 (32) WS=========" >> test_output.txt
/root/mlps/mlp3_32-linux ws >> test_output.txt
echo "========MLP 4 (32)========="
echo "========MLP 4 (32) OS=========" >> test_output.txt
/root/mlps/mlp4_32-linux os >> test_output.txt
echo "========MLP 4 (32) WS=========" >> test_output.txt
/root/mlps/mlp4_32-linux ws >> test_output.txt
