...
echo "copying /root/blis/lib/hwacha/libblis.so.3 to /usr/lib64/"
cp /root/blis/lib/hwacha/libblis.so.3 /usr/lib64/ 
...
#echo "copying /root/lapack-nb-mixed/liblapack.so.3.9.0 /usr/lib64/liblapack.so.3.9.0 to /usr/lib64/"
#cp /root/lapack-nb-mixed/liblapack.so.3.9.0 /usr/lib64/liblapack.so.3.9.0
#cp /root/lapack-nb-mixed/liblapacke.so.3.9.0 /usr/lib64/liblapacke.so.3.9.0
#ln -s /usr/lib64/liblapack.so.3.9.0 /usr/lib64/liblapack.so
