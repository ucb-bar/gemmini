...
RDIR=$(pwd)
FILE=${RDIR}/ddr_evict_sweep_ooo_frfcfs_rand_nobias-c.csv
FATTAILFILE=${RDIR}/ddr_evict_sweep_ooo_frfcfs_rand_nobias_fattail-c.csv
...
do
  ...
  echo "${IJ},${IJ},${K},${NEVICT},${NSEED},${UTIL},${TAIL}" >> ${FILE}
  echo "${IJ},${IJ},${K},${NEVICT},${NSEED},${UTIL},${TAIL}" >> ${FATTAILFILE}
