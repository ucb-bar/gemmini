...
object GemminiISA {
  ...
  val LOOP_MATADD_CONFIG_BOUNDS = 23.U
  val LOOP_MATADD_CONFIG_ADDRS_AB = 24.U
  val LOOP_MATADD_CONFIG_ADDRS_DC = 25.U
  val LOOP_MATADD_CONFIG_STRIDES_AB = 26.U
  val LOOP_MATADD_CONFIG_PACK = 27.U
