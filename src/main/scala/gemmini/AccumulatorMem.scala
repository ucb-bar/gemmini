...
class AccumulatorReadReq[T <: Data: Arithmetic, U <: Data](n: Int, acc_t: T, scale_t: U) extends Bundle {
  ...
  override def cloneType: this.type = new AccumulatorReadReq(n, acc_t.cloneType, scale_t.cloneType).asInstanceOf[this.type]
}
...
class AccumulatorReadResp[T <: Data: Arithmetic, U <: Data](fullDataType: Vec[Vec[T]], scale_t: U) extends Bundle {
  ...
  override def cloneType: this.type = new AccumulatorReadResp(fullDataType.cloneType, scale_t.cloneType).asInstanceOf[this.type]
}
...
class AccumulatorReadIO[T <: Data: Arithmetic, U <: Data](n: Int, fullDataType: Vec[Vec[T]], scale_t: U) extends Bundle {
  ...
  override def cloneType: this.type = new AccumulatorReadIO(n, fullDataType.cloneType, scale_t.cloneType).asInstanceOf[this.type]
}
