...
class WeightedArbiter[T <: Data](t: T, maxWeightA: Int, staticWeightAEnabled: Boolean, onlyStaticWeightA: Boolean) extends Module {
  ...
  val weightA = if (onlyStaticWeightA) { 0.U } else { io.weightA }
