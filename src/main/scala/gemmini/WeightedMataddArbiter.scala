...
class WeightedMataddArbiter[T <: Data](t: T, maxWeightA: Int, staticWeightAEnabled: Boolean) extends Module {
  val io = IO(new Bundle {
    ...
    val inB_i = Input(UInt(16.W)) // TODO magic number
    //val inA_i = Input(UInt(16.W)) // TODO magic number
